...
var MsgConnectionOpenTry = /** @class */ (function (_super) {
    ...
    MsgConnectionOpenTry.fromData = function (data) {
        ...
        return new MsgConnectionOpenTry(client_id, previous_connection_id, client_state, counterparty ? Counterparty_1.Counterparty.fromData(counterparty) : undefined, delay_period, counterparty_versions.length > 0
    ...
    MsgConnectionOpenTry.prototype.toData = function () {
        ...
        return {
            ...
            counterparty_versions: counterparty_versions,
    ...
    MsgConnectionOpenTry.fromProto = function (proto) {
        return new MsgConnectionOpenTry(proto.clientId, proto.previousConnectionId, proto.clientState, proto.counterparty
            ...
            : undefined, proto.delayPeriod.toNumber(), proto.counterpartyVersions.map(function (cv) { return Version_1.Version.fromProto(cv); }), proto.proofHeight ? Height_1.Height.fromProto(proto.proofHeight) : undefined, Buffer.from(proto.proofInit).toString('base64'), Buffer.from(proto.proofClient).toString('base64'), Buffer.from(proto.proofConsensus).toString('base64'), proto.consensusHeight
    ...
    MsgConnectionOpenTry.prototype.toProto = function () {
        ...
        return tx_1.MsgConnectionOpenTry.fromPartial({
            ...
            counterpartyVersions: counterparty_versions.map(function (cv) { return cv.toProto(); }),
