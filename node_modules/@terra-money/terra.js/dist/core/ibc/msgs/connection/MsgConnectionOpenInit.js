...
var MsgConnectionOpenInit = /** @class */ (function (_super) {
    ...
    MsgConnectionOpenInit.fromData = function (data) {
        ...
        return new MsgConnectionOpenInit(client_id, delay_period, signer, counterparty ? Counterparty_1.Counterparty.fromData(counterparty) : undefined, version ? Version_1.Version.fromData(version) : undefined);
    };
