...
var MsgTimeoutOnClose = /** @class */ (function (_super) {
    ...
    MsgTimeoutOnClose.fromData = function (data) {
        ...
        return new MsgTimeoutOnClose(packet ? Packet_1.Packet.fromData(packet) : undefined, proof_close, proof_unreceived, proof_height ? Height_1.Height.fromData(proof_height) : undefined, next_sequence_recv, signer);
    };
