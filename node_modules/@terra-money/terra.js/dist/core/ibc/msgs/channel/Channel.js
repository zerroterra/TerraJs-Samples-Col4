...
var Channel = /** @class */ (function (_super) {
    ...
    Channel.fromAmino = function (data) {
        ...
        return new Channel(state, ordering, Counterparty_1.Counterparty.fromAmino(counterparty), connection_hops, version);
    };
    ...
    Channel.fromData = function (data) {
        var state = data.state, ordering = data.ordering, counterparty = data.counterparty, connection_hops = data.connection_hops, version = data.version;
        return new Channel(state, ordering, Counterparty_1.Counterparty.fromData(counterparty), connection_hops, version);
    };
    ...
    Channel.fromProto = function (proto) {
        return new Channel(proto.state, proto.ordering, Counterparty_1.Counterparty.fromProto(proto.counterparty), proto.connectionHops, proto.version);
    };
