...
var MsgTimeout = /** @class */ (function (_super) {
    ...
    MsgTimeout.fromData = function (data) {
        ...
        return new MsgTimeout(packet ? Packet_1.Packet.fromData(packet) : undefined, proof_unreceived, proof_height ? Height_1.Height.fromData(proof_height) : undefined, next_sequence_recv, signer);
    };
