...
var Packet = /** @class */ (function (_super) {
    ...
    Packet.fromAmino = function (_data) {
        ...
        return new Packet(sequence, source_port, source_channel, destination_port, destination_channel, data, Height_1.Height.fromAmino(timeout_height), timeout_timestamp);
    };
    ...
    Packet.fromData = function (_data) {
        var sequence = _data.sequence, source_port = _data.source_port, source_channel = _data.source_channel, destination_port = _data.destination_port, destination_channel = _data.destination_channel, data = _data.data, timeout_height = _data.timeout_height, timeout_timestamp = _data.timeout_timestamp;
        return new Packet(sequence, source_port, source_channel, destination_port, destination_channel, data, Height_1.Height.fromData(timeout_height), timeout_timestamp);
    };
    ...
    Packet.fromProto = function (proto) {
        return new Packet(proto.sequence.toNumber(), proto.sourcePort, proto.sourceChannel, proto.destinationPort, proto.destinationChannel, Buffer.from(proto.data).toString('base64'), Height_1.Height.fromProto(proto.timeoutHeight), proto.timeoutTimestamp.toNumber());
    };
