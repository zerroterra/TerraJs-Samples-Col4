...
export declare class Packet extends JSONSerializable<Packet.Amino, Packet.Data, Packet.Proto> {
     ...
     */
    constructor(sequence: number, source_port: string, source_channel: string, destination_port: string, destination_channel: string, data: string, timeout_height: Height, timeout_timestamp: number);
