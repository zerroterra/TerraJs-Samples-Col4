...
var ConsensusStateWithHeight = /** @class */ (function (_super) {
    ...
    ConsensusStateWithHeight.fromAmino = function (data) {
        ...
        return new ConsensusStateWithHeight(Height_1.Height.fromAmino(height), consensus_state);
    };
    ...
    ConsensusStateWithHeight.fromData = function (data) {
        var height = data.height, consensus_state = data.consensus_state;
        return new ConsensusStateWithHeight(Height_1.Height.fromData(height), consensus_state);
    };
    ...
    ConsensusStateWithHeight.fromProto = function (proto) {
        return new ConsensusStateWithHeight(proto.height ? Height_1.Height.fromProto(proto.height) : new Height_1.Height(0, 0), // FIXME: is this okay with new object?
