...
var BaseAccount = /** @class */ (function (_super) {
    ...
    BaseAccount.fromData = function (data) {
        var address = data.address, public_key = data.public_key, account_number = data.account_number, sequence = data.sequence;
        return new BaseAccount(address || '', public_key ? PublicKey_1.PublicKey.fromData(public_key) : null, Number.parseInt(account_number) || 0, Number.parseInt(sequence) || 0);
    };
