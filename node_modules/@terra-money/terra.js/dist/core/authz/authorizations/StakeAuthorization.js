...
var StakeAuthorization = /** @class */ (function (_super) {
    ...
    StakeAuthorization.fromData = function (data) {
        return new StakeAuthorization(authz_1.authorizationTypeFromJSON(data.authorization_type), data.max_tokens ? Coin_1.Coin.fromProto(data.max_tokens) : undefined, data.allow_list
    ...
    StakeAuthorization.prototype.toData = function () {
        ...
        return {
            ...
            authorization_type: authz_1.authorizationTypeToJSON(authorization_type),
