...
var MsgTransfer = /** @class */ (function (_super) {
    ...
    MsgTransfer.fromAmino = function (data) {
        ...
        return new MsgTransfer(source_port, source_channel, token ? Coin_1.Coin.fromAmino(token) : undefined, sender, receiver, timeout_height, timeout_timestamp);
    };
    ...
    MsgTransfer.fromData = function (data) {
        ...
        return new MsgTransfer(source_port, source_channel, token ? Coin_1.Coin.fromData(token) : undefined, sender, receiver, timeout_height, timeout_timestamp);
    };
    ...
    MsgTransfer.fromProto = function (proto) {
        return new MsgTransfer(proto.sourcePort, proto.sourceChannel, proto.token ? Coin_1.Coin.fromProto(proto.token) : undefined, proto.sender, proto.receiver, proto.timeoutHeight ? proto.timeoutHeight : undefined, proto.timeoutTimestamp.toNumber());
    };
