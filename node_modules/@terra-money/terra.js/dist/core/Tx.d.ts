...
export declare class ModeInfo {
    single_mode?: ModeInfo.Single | undefined;
    multi_mode?: ModeInfo.Multi | undefined;
    constructor(single_mode?: ModeInfo.Single | undefined, multi_mode?: ModeInfo.Multi | undefined);
...
export declare class CompactBitArray {
    ...
    elems: string;
    constructor(extra_bits_stored: number, elems: string);
