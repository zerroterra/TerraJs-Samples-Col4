...
export declare class StakingAPI extends BaseAPI {
     ...
     */
    delegations(delegator?: AccAddress, validator?: ValAddress, params?: APIParams): Promise<Delegation[]>;
    /**
     ...
     * @param validator validator's operator address
     */
    unbondingDelegations(delegator?: AccAddress, validator?: ValAddress, params?: APIParams): Promise<UnbondingDelegation[]>;
    /**
     ...
     */
    redelegations(delegator?: AccAddress, validatorSrc?: ValAddress, validatorDst?: ValAddress, _params?: APIParams): Promise<Redelegation[]>;
    /**
     * Gets all bonded validators for a delegator given its address.
     * @param delegator delegator's account address
     */
    bondedValidators(delegator: AccAddress, params?: APIParams): Promise<Validator[]>;
    /**
     * Get all current registered validators, including validators that are not currently in the validating set.
     */
    validators(params?: APIParams): Promise<Validator[]>;
    /**
