...
import { Msg, StdTx, StdSignMsg, StdFee, Coins, TxInfo, Numeric, AccAddress } from '../../../core';
...
export declare class TxAPI extends BaseAPI {
     ...
     */
    encode(tx: StdTx, options?: BroadcastOptions): Promise<string>;
    /**
     ...
     */
    broadcast(tx: StdTx, options?: BroadcastOptions): Promise<BlockTxBroadcastResult>;
    /**
     ...
     */
    broadcastSync(tx: StdTx, options?: BroadcastOptions): Promise<SyncTxBroadcastResult>;
    /**
     * Broadcast the transaction using the "async" mode, returning after CheckTx() is performed.
     * @param tx transaction to broadcast
     */
    broadcastAsync(tx: StdTx, options?: BroadcastOptions): Promise<AsyncTxBroadcastResult>;
    /**
