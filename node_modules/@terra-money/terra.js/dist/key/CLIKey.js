...
var StdSignature_1 = require("../core/StdSignature");
...
var CLIKey = /** @class */ (function (_super) {
    ...
    CLIKey.prototype.loadAccountDetails = function () {
        var details = JSON.parse((0, child_process_1.execSync)(this.generateCommand("keys show " + this.params.keyName)).toString());
        ...
        this._accPubKey = bech32_1.bech32.encode('terrapub', Array.from((0, Key_1.pubKeyFromPublicKey)(publicKey)));
    };
    ...
    CLIKey.prototype.createSignature = function (tx) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                (0, fs_1.writeFileSync)(tmpobj.fd, tx.toStdTx().toJSON());
                result = (0, child_process_1.execSync)(this.generateCommand("tx sign " + tmpobj.name + " --yes --signature-only --from " + this.params.keyName + " --offline " +
                ...
                return [2 /*return*/, StdSignature_1.StdSignature.fromData(JSON.parse(result))];
            });
        });
    };
    return CLIKey;
